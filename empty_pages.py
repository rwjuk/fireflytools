...
with conn.cursor() as cur:
	...
	cur.execute("select page_namespace, page_title from page where page_is_redirect=False and page_len=0 and page_namespace in (0,4,6,8,10,12,100,108,446,828) and page_title not like '%/%'  order by page_len limit {};".format(limit))
